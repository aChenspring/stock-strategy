...
def default_rules() -> Dict[str, List[dict]]:
    ...
    return {
        "trend": [
            _r("trend_break", "突破20日新高", "is_break", "bool_true", 0.5,
               desc="收盘价突破近20日高点（0.995容差）"),
            _r("trend_limit5", "近5日有涨停", "limit_up_5", ">=", 0.3, 1,
               desc="近5个交易日出现涨幅≥9.5%"),
            _r("trend_arrange", "均线多头排列", "bull_arrange", "bool_true", 0.2,
               desc="MA5>MA10>MA20>MA60"),
            _r("trend_below", "收盘跌破MA20", "dev_ma20", "<", -0.3, 0,
               desc="收盘价低于MA20扣分"),
        ],
        "ma_system": [
            _r("ma_arrange", "均线多头排列", "bull_arrange", "bool_true", 0.6,
               desc="MA5>MA10>MA20>MA60"),
            _r("ma_dev_ok", "偏离MA60适中", "dev_ma60", "between", 0.4, [0, 0.2],
               group="ma_dev", desc="偏离60日线0~20%"),
            _r("ma_dev_low", "低于MA60", "dev_ma60", "<", 0.1, 0,
               group="ma_dev", desc="偏离60日线为负（微利）"),
        ],
        "volume": [
            _r("vol_amount", "成交额>5亿", "amount", ">=", 0.4, 5e8,
               desc="当日成交额≥5亿元"),
            _r("vol_turnover", "换手>10%", "turnover", ">=", 0.3, 10,
               desc="当日换手率≥10%"),
            _r("vol_ratio_high", "量比>2", "vol_ratio", ">=", 0.3, 2,
               group="vol_ratio", desc="当日量比≥2"),
            _r("vol_ratio_mid", "量比≥1.2", "vol_ratio", ">=", 0.15, 1.2,
               group="vol_ratio", desc="当日量比≥1.2（未达2时）"),
        ],
        "main_flow": [
        ...
        "momentum": [
            _r("mom_rsi_ok", "RSI强势区", "rsi6", "between", 0.6, [50, 75],
               group="mom_rsi", desc="RSI6 处于 50-75 强势未钝化"),
            _r("mom_rsi_high", "RSI极端高位", "rsi6", ">", 0.2, 85,
               group="mom_rsi", desc="RSI6>85 极端高位"),
            _r("mom_rsi_mid", "RSI中性区", "rsi6", ">=", 0.3, 30,
               group="mom_rsi", desc="RSI6≥30 中性偏多"),
            _r("mom_kd_strong", "KD金叉强势", "kd_strong", "bool_true", 0.4,
               group="mom_kd", desc="K>D 且 K>50"),
            _r("mom_kd_weak", "KD死叉", "kd_weak", "bool_true", 0.15,
               group="mom_kd", desc="K<D"),
        ],
        "volatility": [
            _r("vol_amp_low", "振幅<10%", "amplitude", "<", 0.8, 10,
               group="vol_amp", desc="当日振幅<10%（低波动高分）"),
            _r("vol_amp_mid", "振幅<20%", "amplitude", "<", 0.5, 20,
               group="vol_amp", desc="当日振幅<20%"),
            _r("vol_amp_high", "振幅≥20%", "amplitude", ">=", 0.2, 20,
               group="vol_amp", desc="当日振幅≥20%"),
        ],
        "board": [
