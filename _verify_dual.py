# -*- coding: utf-8 -*-
"""次规则「牛市回调超卖」验证：2020窗口 主-14 + 次(-8, chg60>0)。"""
import time
...
CFGS = [
    dict(market_chg20_max=-14.0),                          # 单主规则 +45.61%
    dict(market_chg20_max=-14.0, market_chg20_max2=-8.0, market_chg60_min=0.0),  # 双规则
    dict(market_chg20_max=-12.0, market_chg20_max2=-8.0, market_chg60_min=0.0),  # 主-12+次
    dict(market_chg20_max=-14.0, market_chg20_max2=-10.0, market_chg60_min=0.0), # 主-14+次-10
]
