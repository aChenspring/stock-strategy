# -*- coding: utf-8 -*-
"""全量验证：2020窗口 hold15 / 默认窗口 hold15。"""
import time
...
CFGS = [
    dict(start="20200101", hold_days=15),
    dict(start="20200101", hold_days=12),
    dict(start="", hold_days=15),
]
...
for i, extra in enumerate(CFGS):
    ...
    try:
        ...
        print(f"[{i}] start={extra.get('start') or '默认'} hold={extra.get('hold_days')}")
